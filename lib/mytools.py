...
class colorPrint():
    # 彩色打印输出
    # print("\033[显示方式；前景颜色；背景颜色m 字符串 \033[0m")

    @classmethod
    def red(self, strings):
        print(f"\033[0;31;40m{strings}\033[0m")

    @classmethod
    def green(self, strings):
        print(f"\033[5;32;40m{strings}\033[0m")

    @classmethod
    def yellow(self, strings):
        print(f"\033[0;33;40m{strings}\033[0m")

    @classmethod
    def blue(self, *strings):
        print(f"\033[0;34;40m{strings}\033[0m")

    @classmethod
    def purple(self, strings):
        print(f"\033[0;35;40m{strings}\033[0m")

    @classmethod
    def cyanblue(self, strings):
        print(f"\033[0;36;40m{strings}\033[0m")

    @classmethod
    def white(self, strings):
        print(f"\033[0;37;40m{strings}\033[0m")
